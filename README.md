...
Este repositorio incluye un ejemplo de script para inicializar la estructura estándar de un proyecto del curso de Machine Learning Aplicado a las Finanzas.

## Descripción

El script crea un proyecto con la siguiente estructura:
...
También agrega archivos de configuración básicos como `.gitignore`, `README.md` y `environment.yml`.
...
Ejecuta el script para crear un nuevo proyecto:

```python
crear_estructura_proyecto("mi_proyecto")
```
